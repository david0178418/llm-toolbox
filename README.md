...
```bash
codex plugin marketplace add owner/repo --ref marketplace --sparse .agents/plugins --sparse plugins
```

Claude Code:

```bash
claude plugin marketplace add owner/repo@marketplace --sparse .claude-plugin plugins
```
